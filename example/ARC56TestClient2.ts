  ...
  params = (methodParams?: MethodParams) => {
    return {
      ...
      optInToApplication: (): MethodCallParams => {
        return this.getParams("optInToApplication", methodParams);
      },
      createApplication: (): MethodCallParams => {
        return this.getParams("createApplication", methodParams);
      },
    };
  };
  ...
  optIn = (methodParams: MethodParams = {}) => {
    return {
      optInToApplication: async (): Promise<{
        ...
        return this.optInMethodCall("optInToApplication", methodParams);
      },
    };
  };
  ...
  create = (
    ...
    return {
      createApplication: async (): Promise<{
        ...
        return this.createMethodCall("createApplication", methodParams);
      },
    };
  };
